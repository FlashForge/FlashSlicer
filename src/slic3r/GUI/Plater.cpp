                ...
                Semver             file_version;
                {
                    ...
                    if (en_3mf_file_type == En3mfType::From_Prusa) {
                        ...
                        if(load_type != LoadType::LoadGeometry)
                            show_info(q, _L("The 3mf is not supported by FlashSlicer, load geometry data only."), _L("Load 3mf"));
                    }
                        ...
                        if (load_type != LoadType::LoadGeometry) {
                            if (en_3mf_file_type == En3mfType::From_BBS)
                                show_info(q, _L("The 3mf is generated by old Flash Slicer, load geometry data only."), _L("Load 3mf"));
                            else
                                show_info(q, _L("The 3mf is not supported by FlashSlicer, load geometry data only."), _L("Load 3mf"));
                        }
