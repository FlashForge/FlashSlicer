...
void set_log_path_and_level(const std::string& file, unsigned int level)
{
	...
	//BBS log file at C:\\Users\\[yourname]\\AppData\\Roaming\\FlashSlicer\\log\\[log_filename].log
...
{
	return std::string(SLIC3R_APP_NAME " " FlashForge_VERSION);
}

std::string header_gcodeviewer_generated()
{
	return std::string(GCODEVIEWER_APP_NAME " " FlashForge_VERSION);
}
